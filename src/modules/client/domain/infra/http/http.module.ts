...
@Module({
  ...
  controllers: [CreateClientController, FetchClientsController, FetchClientController, EditClientController],
  providers: [CreateClientUseCase, FetchClientsUseCase, FetchClientUseCase, EditClientUseCase]
})
